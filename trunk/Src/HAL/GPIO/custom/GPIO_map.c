...
const tGPIOInstanceMap GPIOInstanceMap[NUM_OF_GPIO] =
{
		...
		/* GPIO_LED_1          	  */ { GPIOB, GPIO_PIN_3, GPIO_MODE_OUTPUT_PP, GPIO_SPEED_HIGH, GPIO_NOPULL, GPIO_AF_NONE, GPIO_DEFAULT },
		...
		/* SPI1 for ST-NUCLEO-F030R8*/
		/* SCK                      */ { GPIOA, GPIO_PIN_7, GPIO_MODE_AF_PP, GPIO_SPEED_HIGH, GPIO_PULLDOWN, GPIO_AF0_SPI1, GPIO_DEFAULT },
		/* MISO                     */ { GPIOA, GPIO_PIN_6, GPIO_MODE_AF_PP, GPIO_SPEED_HIGH, GPIO_PULLDOWN, GPIO_AF0_SPI1, GPIO_DEFAULT },
		/* MOSI                     */ { GPIOA, GPIO_PIN_5, GPIO_MODE_AF_PP, GPIO_SPEED_HIGH, GPIO_PULLDOWN, GPIO_AF0_SPI1, GPIO_DEFAULT },

		/* SPI2 for ST-NUCLEO-F030R8*/
		/* SCK                      */ { GPIOB, GPIO_PIN_15, GPIO_MODE_AF_PP, GPIO_SPEED_HIGH, GPIO_PULLDOWN, GPIO_AF0_SPI2, GPIO_DEFAULT },
		/* MISO                     */ { GPIOB, GPIO_PIN_14, GPIO_MODE_AF_PP, GPIO_SPEED_HIGH, GPIO_PULLDOWN, GPIO_AF0_SPI2, GPIO_DEFAULT },
		/* MOSI                     */ { GPIOB, GPIO_PIN_13, GPIO_MODE_AF_PP, GPIO_SPEED_HIGH, GPIO_PULLDOWN, GPIO_AF0_SPI2, GPIO_DEFAULT },

		/* GPIO_PWM_TEST			*/ { GPIOB, GPIO_PIN_4,	GPIO_MODE_AF_PP, GPIO_SPEED_LOW, GPIO_NOPULL, GPIO_AF1_TIM3, GPIO_DEFAULT },

		/* I2C1 for ST-NUCLEO-F030R8*/
		/* SCL                      */ { GPIOB, GPIO_PIN_6,  GPIO_MODE_AF_OD, GPIO_SPEED_HIGH, GPIO_PULLUP  , GPIO_AF1_I2C1, GPIO_DEFAULT },
		/* SDA                      */ { GPIOB, GPIO_PIN_7,  GPIO_MODE_AF_OD, GPIO_SPEED_HIGH, GPIO_PULLUP  , GPIO_AF1_I2C1, GPIO_DEFAULT },

		/* I2C2 for ST-NUCLEO-F030R8*/
		/* SCL                      */ { GPIOB, GPIO_PIN_10, GPIO_MODE_AF_OD, GPIO_SPEED_HIGH, GPIO_PULLDOWN, GPIO_AF1_I2C2, GPIO_DEFAULT },
		/* SDA                      */ { GPIOB, GPIO_PIN_11, GPIO_MODE_AF_OD, GPIO_SPEED_HIGH, GPIO_PULLDOWN, GPIO_AF1_I2C2, GPIO_DEFAULT },
