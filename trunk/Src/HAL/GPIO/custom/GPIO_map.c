...
const tGPIOInstanceMap GPIOInstanceMap[NUM_OF_GPIO] =
{
		...
		/* SPI1 */
			/* GPIO_SPI1_MISO 			*/ 		{ GPIOA, GPIO_PIN_6,  GPIO_MODE_AF_PP,	  	GPIO_SPEED_LOW, GPIO_NOPULL, GPIO_AF5_SPI1, GPIO_DEFAULT },
			/* GPIO_SPI1_MOSI			*/ 		{ GPIOA, GPIO_PIN_7,  GPIO_MODE_AF_PP,	 	GPIO_SPEED_LOW, GPIO_NOPULL, GPIO_AF5_SPI1, GPIO_DEFAULT },
			/* GPIO_SPI1_CLK/SCK		*/	 	{ GPIOA, GPIO_PIN_1,  GPIO_MODE_AF_PP,	  	GPIO_SPEED_LOW, GPIO_PULLDOWN, GPIO_AF5_SPI1, GPIO_DEFAULT },
//			/* GPIO_SPI1_NSS			*/ 		{ GPIOA, GPIO_PIN_4,  GPIO_MODE_INPUT_PP, GPIO_SPEED_LOW, GPIO_NOPULL, GPIO_AF5_SPI1, GPIO_DEFAULT },

		/* SPI3 */
			/* GPIO_SPI3_MISO 			*/ 		{ GPIOC, GPIO_PIN_12,  GPIO_MODE_AF_PP,	  	GPIO_SPEED_LOW, GPIO_NOPULL, GPIO_AF6_SPI3, GPIO_DEFAULT },
			/* GPIO_SPI3_MOSI			*/ 		{ GPIOC, GPIO_PIN_11,  GPIO_MODE_AF_PP,	 	GPIO_SPEED_LOW, GPIO_NOPULL, GPIO_AF6_SPI3, GPIO_DEFAULT },
			/* GPIO_SPI3_CLK/SCK		*/	 	{ GPIOC, GPIO_PIN_10,  GPIO_MODE_AF_PP,	  	GPIO_SPEED_LOW, GPIO_PULLDOWN, GPIO_AF6_SPI3, GPIO_DEFAULT },
//			/* GPIO_SPI3_NSS			*/ 		{ GPIOA, GPIO_PIN_15,  GPIO_MODE_OUTPUT_PP, GPIO_SPEED_LOW, GPIO_NOPULL, GPIO_AF6_SPI3, GPIO_DEFAULT },
