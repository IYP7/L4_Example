...
tInterruptsInstanceMap interruptsInstanceMap[MAX_IRQ] =
{
		...
		/* IRQ_USART1		*/	{USART1_IRQn		,	INT_PRIORITY_1	 ,	INT_SUBPRIORITY_0,		IRQ_ENABLE	},
		...
		/* IRQ_SPI3  		*/	{SPI3_IRQn          ,	INT_PRIORITY_1	 ,	INT_SUBPRIORITY_0,		IRQ_DISABLE	},
		/* IRQ_DMA2_CH3		*/	{DMA2_Channel3_IRQn	,	INT_PRIORITY_2	 ,	INT_SUBPRIORITY_0,		IRQ_DISABLE  },
		/* IRQ_DMA2_CH6		*/	{DMA2_Channel6_IRQn	,	INT_PRIORITY_2	 ,	INT_SUBPRIORITY_0,		IRQ_DISABLE  },
};
